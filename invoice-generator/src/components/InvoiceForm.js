...
class InvoiceForm extends React.Component {
  ...
  render() {
    return (
      <Form onSubmit={this.openModal} className="container">
        <Row>
          <Col md={8} lg={9}>
          ...
          <Col md={4} lg={3}>
            ...
            <Button variant="primary" type="submit" className="d-block w-100 mt-4">
                  Review Invoice
                </Button>
              <Link to="/" className="btn btn-dark mt-3 w-100" role="button">
                View Invoices
              </Link>
              <InvoiceModal
...
export default connect(mapStateToProps)(Router(InvoiceForm));
